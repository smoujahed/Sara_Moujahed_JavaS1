...
public class AllKatasTest {
    ...
    public void testAChattyProgramOutput() throws Exception {
        ...
        String output = readFile("testfiles/com.company.AChattyProgram/output.txt");
    ...
    public void testAPostCardFromMeOutput() throws Exception {
        ...
        String output = readFile("testfiles/com.company.APostcardFromMe/output.txt");
    ...
    public void testMarvelTable() throws Exception {
        ...
        String output = readFile("testfiles/com.company.MarvelTable/output.txt");
