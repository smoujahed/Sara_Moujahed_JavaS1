    ...
    public static void main(String[] args) {
        ...
        while (a > 0 || b > 0 || c > 0) {
            ...
            if (pileChoice1.equals("a") || pileChoice1.equals("A")) {
                    if (a <=0) {
                        System.out.println("Nice try " + currentPlayer +
                                ". That pile is empty. Choose again: ");
                        pileChoice1 = scanner.nextLine();
                    }
            ...
            if(removeNum1 <= 0 ) {
                ...
                removeNum1 = Integer.parseInt(scanner.nextLine());
